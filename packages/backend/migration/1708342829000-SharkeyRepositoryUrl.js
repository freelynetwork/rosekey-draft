...
export class SharkeyRepositoryUrl1708342829000 {
  ...
  async up(queryRunner) {
    await queryRunner.query(`ALTER TABLE "meta" ALTER COLUMN "repositoryUrl" SET DEFAULT 'https://github.com/freelynetwork/rosekey'`);
    await queryRunner.query(`ALTER TABLE "meta" ALTER COLUMN "feedbackUrl" SET DEFAULT 'https://github.com/freelynetwork/rosekey/issues/new'`);
